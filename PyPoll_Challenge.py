...
county_list = {}    # list of county names
county_votes = []   # dictionary of votes by county
...
highest_turnout = ""    # county name
county_turnout = 0      # county vote count
county_percentage = 0   # vote percentage by county
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_list:
        ...
        cvotes = county_list.get(county_name)
        ...
        if (cvotes > county_turnout) and (cvote_percentage > county_percentage):
    ...
    txt_file.write(f"{largest_county_summary}\n")
